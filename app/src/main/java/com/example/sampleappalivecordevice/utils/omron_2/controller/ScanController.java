package com.example.sampleappalivecordevice.utils.omron_2.controller;
...
import com.example.sampleappalivecordevice.omron.model.entity.DiscoveredDevice;
...
public class ScanController {
    ...
    public void stopScan() {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                mIsRemoveHandlerCallbacks = true;
                mHandler.removeCallbacks(mBatchedScanRunnable);
                _stopScan();
            }
        });
    ...
    private void _startScan(@Nullable OHQDeviceCategory filteringDeviceCategory) {
        ...
        mIsScanning = true;
        mDiscoveredDevices.clear();
        mIsRemoveHandlerCallbacks = false;
